    ...
    <div class="sidebar-menu fixed">
        <div class="sidebar-menu-inner">
            ...
            <ul id="main-menu" class="main-menu">
		        <li class="">
                    <a href="<?php echo base_url().'radiologi'?>">
                ...
                <li class="has-sub <?php echo $this->uri->segment(2)=='kunjungan'?'opened':''?>">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="<?php echo base_url().'radiologi/kunjungan/register'?>">
                        ...
                        <li>
                            <a href="<?php echo base_url().'radiologi/kunjungan/data'?>">
                ...
                <li class="has-sub <?php echo $this->uri->segment(2)=='laporan'?'opened':''?>">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="<?php echo base_url().'radiologi/laporan/laporanharian'?>">
