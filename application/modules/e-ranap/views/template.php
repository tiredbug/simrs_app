...
<head>
	...
	<title>SIMRS - Pelayanan Rawat Inap</title>
    ...
    <div class="sidebar-menu fixed">
        <div class="sidebar-menu-inner">
            ...
            <ul id="main-menu" class="main-menu">
		        <li class="">
                    <a href="<?php echo base_url().'e-ranap'?>">
                ...
                <li class="main-menu">
                    <a href="<?php echo base_url().'e-ranap/penatajasa'?>">
                ...
                <li class="has-sub">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="<?php echo base_url().'e-ranap/keluar'?>" )>
