    ...
    <div class="sidebar-menu fixed">
        <div class="sidebar-menu-inner">
            ...
            <ul id="main-menu" class="main-menu">
		        <li class="">
                    <a href="<?php echo base_url().'igd/home'?>">
                ...
                <li class="has-sub <?php echo $this->uri->segment(2)=='pasien'?'opened':''?>">
                    ...
                    <ul>
                        <li class="">
                            <a href="<?php echo base_url().'igd/pasien/register'?>">
                                <i class="entypo-pencil"></i>
                                <span class="title">Pasien baru</span>
                            </a>
                        </li>  
                        <li class="">
                            <a href="<?php echo base_url().'igd/pasien/database'?>">
                ...
                <li class="has-sub <?php echo $this->uri->segment(2)=='kunjungan'?'opened':''?>">
                    ...
                    <ul>
                        <li class="">
                            <a href="<?php echo base_url().'igd/kunjungan/register'?>">
                                <i class="entypo-pencil"></i>
                                <span class="title">Daftar</span>
                            </a>
                        </li>  
                        <li class="">
                            <a href="<?php echo base_url().'igd/kunjungan/data'?>">
                                <i class="entypo-drive"></i>
		...
		<ul class="user-info pull-left pull-none-xsm">
                    <li class="profile-info dropdown"><!-- add class "pull-right" if you want to place this from right -->
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a href="<?php echo base_url().'igd/Keluar'?>" onclick="return true confirm('Keluar dari aplikasi ?'')">
