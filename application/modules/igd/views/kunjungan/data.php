                ...
                <div class="modal-body body-modal-informasi">
                    <div class="row">
                        <div class="col-sm-3">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <button class="btn btn-block btn-primary btn-icon icon-left btn_entry"><i class='entypo-pencil'></i> Entry tindakan pelayanan</button>
                                    <button class="btn btn-block btn-danger btn-icon icon-left btn_hapus" ><i class='entypo-trash'></i> Hapus kunjungan</button>
                                    <button class="btn btn-block btn-orange btn-icon icon-left btn_tutup"><i class='entypo-block'></i> Tutup transaksi</button>
                                    <button class="btn btn-block btn-success btn-icon icon-left btn_close"><i class='entypo-cancel'></i> Tutup Form</button>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
			...
			"rowCallback":function(row, data, index)
            {
            	$("td:eq(0)",row).html("<div class='btn-group'>"+
            								...
            								"<ul class='dropdown-menu dropdown-blue' role='menu'>"+
            									...
            									"</li>"+
            									"<li>"+
            										"<a href='#' onClick='tutuptransaksi(\""+data[1]+"\")'><i class='entypo-right'></i>Tutup transaksi</a>"+
            									"</li>"+
            								"</ul>"+
            							"</div>")
            }
	...
	$(".btn_close").click(function(){
		$("#modal_informasi_kunjungan").modal('hide')
	})
	$(".btn_entry").click(function(){
		entrytindakan($("#nokunjungan").val())
	})
	$(".btn_hapus").click(function(){
		hapus($("#nokunjungan").val())
		$("#modal_informasi_kunjungan").modal('hide')
	})
