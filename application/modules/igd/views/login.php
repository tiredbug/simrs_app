...
<body>
    ...
    <script>
        $('.form-login').submit(function(e){
            ...
            $.ajax({
                type:"POST",
                url:'<?php echo base_url()?>igd/login/login_auth',
                data:form_data,
                dataType:"JSON",
                error:function(xhr, desc, err)
                {
                    ...
                    swal({
                        ...
                        text:"Gagal terhubung ke server, periksa koneksi anda lalu coba lagi.",
                        imageUrl:'<?php echo base_url()?>template/assets/img/diskonek.png'
                    })
                    no_loading();
                },
                success:function(json)
                {
                    ...
                    else
                    {
                        swal({
                            title:'Login gagal !',
                            text:"Gagal terhubung ke server, periksa koneksi anda lalu coba lagi.",
                            imageUrl:'<?php echo base_url()?>template/assets/img/loginfailed.png'
                        })
                        no_loading();
                    }
                }
