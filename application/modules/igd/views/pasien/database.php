<div class="panel panel-primary konten">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-drive"></i> Database Pasien
        </div>
...
<script type="text/javascript">
	...
	var table3 = $table3.DataTable( {
            ...
            {
                type:'post',
                url:base_url+'igd/pasien_api/get_databasepasien',
    ...
    $(".prov").change(function(){
        ...
        $.ajax({
            type:"POST",
            url:base_url+'igd/pasien_api/get_kab',
    ...
    $(".kab").change(function(){
        ...
        $.ajax({
            type:"POST",
            url:base_url+'igd/pasien_api/get_kec',
    ...
    $(".kec").change(function(){
        ...
        $.ajax({
            type:"POST",
            url:base_url+'igd/pasien_api/get_desa',
    ...
    function load_profile(norek)
    {
        ...
        $.ajax({
            type:'post',
            url:base_url+'igd/pasien_api/get_infopasien',
            data:'norek='+norek,
            dataType:'json',
            error:function()
            {
    ...
    $(".btn-primary").click(function(){
        window.location.href=base_url+'igd/pasien/edit_pasien?norec='+$(".norek-h").val()
    })
    $(".btn-orange").click(function(){
        var e=confirm("Apakah ingin mencetak kembali kartu berobat pasien ?");
        if(e)
        {
            window.open(base_url+'igd/pasien/kartu?norek='+$(".norek-h").val(),'_blank');
        }
    })
</script>
