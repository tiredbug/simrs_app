    ...
    <div class="sidebar-menu fixed">
        <div class="sidebar-menu-inner">
            ...
            <ul id="main-menu" class="main-menu">
		        <li class="">
                    <a href="<?php echo base_url().'gudangobat'?>">
                        <i class="entypo-home"></i>
                        <span class="title">Home</span>
                    </a>
                </li>

                <li class="has-sub <?php echo $this->uri->segment(2)=='master'?'opened':''?>">
                    <a href="#">
                    ...
                    <ul>
                        <li>
                            <a href="<?php echo base_url().'gudangobat/master/obat'?>">
                                <span class="title">Obat</span>
                            </a>
                        </li>

                        <li>
                            <a href="<?php echo base_url().'gudangobat/master/supplier'?>">
...
<!-- cek notifikasi, dan bunyikan notifikasi jika ada stok yang expired atau sould out.         -->
...
$(document).ready(function(){
    ...
    function cek_stok()
    {
        $.ajax({
            type:"POST",
            url:base_url+'gudangobat/kontrol_api/cek_notif_stok',
            success:function(respon)
            {
                if(respon > 0)
                {
                    notif();
                    toastr.error(respon+' barang sudah kurang dari 30%.');
                }
            }
        })
    }
    ...
    {
        var suara=new Audio();
        suara.src=base_url+'template/sound/notifikasi.mp3'
        suara.play();
    }
</script>
</body>
