        ...
        <div class="sidebar-menu-inner">
            ...
            <ul id="main-menu" class="main-menu">
                ...
                <!-- <li class="has-sub">
                    ...
                    <ul>
                        <li>
                            <a href="<?php echo base_url().'lab/kunjungan/resiter'?>">
                                <span class="title">Register</span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo base_url().'lab/kunjungan/orderan'?>">
                                <span class="title">Orderan</span>
                            </a>
                         </li>
                    </ul>
                ...
                <li class="has-sub">
                    ...
                    <ul>
                        <li>
                            <a href="<?php echo base_url().'lab/register'?>">
                                <span class="title">Registrasi</span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo base_url().'lab/hasil'?>">
                                <span class="title">Input Hasil</span>
                            </a>
			             </li>
                    </ul>
                </li>
                ...
                <li class="has-sub">
                    ...
                    <ul>
                        <li>
                            <a href="<?php echo base_url().'lab/orderan'?>">
                                <span class="title">Orderan Pemeriksaan</span>
                            </a>
                        </li>
                        <li>
                            <a href="dashboard-2.html">
                                <span class="title">History Pemeriksaan</span>
                            </a>
			            </li>
                ...
                <li class="has-sub">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="<?php echo base_url().'lab/Keluar'?>" )>
